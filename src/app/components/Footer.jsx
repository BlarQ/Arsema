  ...
  return (
    <footer className='bg-[#f2efea] flex flex-col gap-4 divide-y px-[5%] text-[#4a6b92] bottom-0 inset-x-0'>
        ...
        <div className='flex items-center justify-center py-4 text-center'>
            <p>&copy; {new Date().getFullYear()}. ARSEMA PURE NATURALS - Desined by <Link className='text-blue-800 underline' href={'https://www.github.com/Syanda9'} target='_blank'>Pholoba</Link> & <Link className='text-blue-800 underline' href={'https://www.github.com/BlarQ'} target='_blank'>BlarQ</Link></p>
        </div>
